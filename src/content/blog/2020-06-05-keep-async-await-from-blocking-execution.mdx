...
Have other ideas for speeding up async functions? [Hit me up on Twitter!](https://twitter.com/compose/tweet?text=I%20just%20learned%20how%20to%20keep%20async/await%20function%20fast%20from%20@jlengstorf&url=https://codetv.dev/blog/keep-async-await-from-blocking-executionn/)
