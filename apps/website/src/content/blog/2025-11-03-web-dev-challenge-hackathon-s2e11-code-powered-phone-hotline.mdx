...
Ready to get started? Check out the [ConversationRelay docs](https://www.twilio.com/docs/voice/conversationrelay), dive into one of the [tutorials on the Twilio blog](https://www.twilio.com/en-us/blog/developers/tutorials/product/integrate-openai-twilio-voice-using-conversationrelay), or check out the [starter repo on Github](https://github.com/robinske/cr-demo).
...
Finally, whether you’ve built a hotline or just have a great idea, share it in [the challenge thread on Twilio's X account][submit] or [LinkedIn post](https://www.linkedin.com/posts/twilio-inc-_twilio-hotline-challenge-activity-7393694154926559232-nbx6). The top five ideas by total likes, comments, and reshares at the deadline will each receive a gift card valued at $25. As a bonus, we will be building one standout idea live on Twitch with Alex and Jason.
...
8. 11:59 pm Pacific on Friday, Nov 21, 2025 by [replying to Twilio's post on X][submit] or [on LinkedIn](https://www.linkedin.com/posts/twilio-inc-_twilio-hotline-challenge-activity-7393694154926559232-nbx6)

### Bonus: you can also win for a great idea!

If you don’t have time to build a hotline, you can _also_ win by submitting our favorite hotline idea. [Reply to the post][submit] with your idea, and if we decide to build it, you’ll win a prize!
...
[submit]: https://x.com/twilio/status/1987971002643710442
