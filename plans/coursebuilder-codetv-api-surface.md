...
4. Core content CRUD: resources, edges, workshops, lessons, products.
...
| ----------------------------------------------------- | --------------------- | ----------------------------- | ---------------------------------------------------------------------------------------- |
| `GET/POST/PUT/DELETE /api/resources`                  | CWA strongest         | required                      | Generic content resource CRUD, ability-gated.                                            |
